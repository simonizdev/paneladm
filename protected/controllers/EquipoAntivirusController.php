...
class EquipoAntivirusController extends Controller
{
	/**
	...
	public function actionCreate($e)
	{
		...
		$versiones_antivirus=Dominio::model()->findAll(array('order'=>'Dominio', 'condition'=>'Estado=:estado AND Id_Padre = '.Yii::app()->params->version_antivirus, 'params'=>array(':estado'=>1)));
		...
		if(isset($_POST['EquipoAntivirus']))
		{
			$rnd = rand(0,99999);  // genera un numero ramdom entre 0-99999
			$model->attributes=$_POST['EquipoAntivirus'];
		...
		$this->render('create',array(
			...
			'versiones_antivirus' => $versiones_antivirus,
			'empresas'=>$empresas,
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['EquipoAntivirus']))
		{
			if($_FILES['EquipoAntivirus']['name']['sop']  != "") {
	 ...
	 * @return EquipoAntivirus the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=EquipoAntivirus::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param EquipoAntivirus $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='equipo-antivirus-form')
		{
