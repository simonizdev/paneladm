...
class EquipoSoController extends Controller
{
	/**
	...
	public function actionCreate($e)
	{
		...
		$versiones_so=Dominio::model()->findAll(array('order'=>'Dominio', 'condition'=>'Estado=:estado AND Id_Padre = '.Yii::app()->params->version_so, 'params'=>array(':estado'=>1)));
	 ...
	 * @return EquipoSo the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=EquipoSo::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param EquipoSo $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='equipo-so-form')
		{
