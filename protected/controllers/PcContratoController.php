...
class PcContratoController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['PcContrato']))
		{
			$model->attributes=$_POST['PcContrato'];
	...
	{
		$dataProvider=new CActiveDataProvider('PcContrato');
	...
	{	
		...
		if(isset($_GET['PcContrato']))
			$model->attributes=$_GET['PcContrato'];
	 ...
	 * @return PcContrato the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=PcContrato::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param PcContrato $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='pc-contrato-form')
		{
	...
	{		
		...
		$modeloconalerta=PcContrato::model()->findAll("DATEDIFF(day,'".date('Y-m-d')."',Fecha_Ren_Can) < Dias_Alerta AND Estado = 1");
		$numconalerta = count ($modeloconalerta);
		$modelosinalerta=PcContrato::model()->findAll("DATEDIFF(day,'".date('Y-m-d')."',Fecha_Ren_Can) >= Dias_Alerta AND Estado = 1");
		$numsinalerta = count ($modelosinalerta);
		$modeloinactivos=PcContrato::model()->findAll("Estado = 0");
