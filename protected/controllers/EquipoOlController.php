...
class EquipoOlController extends Controller
{
	/**
	...
	public function actionCreate($e)
	{
		...
		$otros_productos=Dominio::model()->findAll(array('order'=>'Dominio', 'condition'=>'Estado=:estado AND Id_Padre = '.Yii::app()->params->otro_prod_lic, 'params'=>array(':estado'=>1)));
	 ...
	 * @return EquipoOl the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=EquipoOl::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param EquipoOl $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='equipo-ol-form')
		{
