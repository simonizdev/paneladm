...
class EquipoAdobeController extends Controller
{
	/**
	...
	public function actionCreate($e)
	{
		...
		$versiones_adobe=Dominio::model()->findAll(array('order'=>'Dominio', 'condition'=>'Estado=:estado AND Id_Padre = '.Yii::app()->params->version_adobe, 'params'=>array(':estado'=>1)));
		...
		if(isset($_POST['EquipoAdobe']))
		{
			$rnd = rand(0,99999);  // genera un numero ramdom entre 0-99999
			$model->attributes=$_POST['EquipoAdobe'];
		...
		$this->render('create',array(
			...
			'versiones_adobe' => $versiones_adobe,
			'empresas'=>$empresas,
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['EquipoAdobe']))
		{
			if($_FILES['EquipoAdobe']['name']['sop']  != "") {
	 ...
	 * @return EquipoAdobe the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=EquipoAdobe::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param EquipoAdobe $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='equipo-adobe-form')
		{
