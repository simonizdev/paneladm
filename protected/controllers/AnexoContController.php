...
class AnexoContController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('AnexoCont');
	...
	{
		$model=new AnexoCont('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['AnexoCont']))
			$model->attributes=$_GET['AnexoCont'];
