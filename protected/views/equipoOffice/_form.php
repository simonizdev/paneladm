...
<div class="row">
    	...
    	<div class="form-group">
            ...
            <?php
                $this->widget('ext.select2.ESelect2',array(
                    'name'=>'EquipoOffice[Tipo_Licencia]',
                    'id'=>'EquipoOffice_Tipo_Licencia',
                    'data'=>$tipos_licencia,
    ...
    <div class="col-sm-4">
    	<div class="form-group">
            ...
            <?php
                $this->widget('ext.select2.ESelect2',array(
                    'name'=>'EquipoOffice[Version]',
                    'id'=>'EquipoOffice_Version',
                    'data'=>$versiones_office,
                    'value' => $model->Version,
                    'htmlOptions'=>array(),
                    'options'=>array(
                        'placeholder'=>'Seleccione...',
...
<div class="row">
	<div class="col-sm-4">
    	<div class="form-group">
            ...
            <?php
                $this->widget('ext.select2.ESelect2',array(
                    'name'=>'EquipoOffice[Producto]',
                    'id'=>'EquipoOffice_Producto',
                    'data'=>$productos_office,
    ...
    <div class="col-sm-4">
    	<div class="form-group">
      		...
      		<?php echo $form->textField($model,'Id_Licencia', array('class' => 'form-control', 'maxlength' => '200', 'autocomplete' => 'off', 'onkeyup' => 'convert_may(this)')); ?>
      	</div>	
  	</div>
	<div class="col-sm-4">
    	<div class="form-group">
...
<div class="row">
	<div class="col-sm-4">
    	<div class="form-group">
      		...
      		<?php echo $form->textField($model,'Token', array('class' => 'form-control', 'maxlength' => '200', 'autocomplete' => 'off', 'onkeyup' => 'convert_may(this)')); ?>
      	</div>	
  	</div>
  <div class="col-sm-4">
		<div class="form-group">
...
<div class="row">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <?php
                $this->widget('ext.select2.ESelect2',array(
                    'name'=>'EquipoOffice[Empresa_Compra]',
                    'id'=>'EquipoOffice_Empresa_Compra',
                    'data'=>$lista_empresas,
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <?php
                $this->widget('ext.select2.ESelect2',array(
                    'name'=>'EquipoOffice[Proveedor]',
                    'id'=>'EquipoOffice_Proveedor',
...
<div class="row">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <?php
                $this->widget('ext.select2.ESelect2',array(
                    'name'=>'EquipoOffice[Estado]',
                    'id'=>'EquipoOffice_Estado',
                    'data'=>$estados,
                    'value' => $model->Estado,
                    'htmlOptions'=>array(),
                    'options'=>array(
...
$(function() {
  ...
  var pesoPermitido2 = 512;
	...
	$("#valida_form").click(function() {
      var form = $("#equipo-office-form");
      var settings = form.data('settings') ;

      var soporte = $('#EquipoOffice_sop').val();
  ...
  //variables para el lenguaje del datepicker
	...
	$("#EquipoOffice_Fecha_Inicio").datepicker({
	  language: 'es',
	  autoclose: true,
	  orientation: "right bottom",
	}).on('changeDate', function (selected) {
	   var minDate = new Date(selected.date.valueOf());
	   $('#EquipoOffice_Fecha_Final').datepicker('setStartDate', minDate);
	});

	$("#EquipoOffice_Fecha_Final").datepicker({
	  language: 'es',
	  autoclose: true,
	  orientation: "right bottom",
	}).on('changeDate', function (selected) {
