...
<h3>Visualizando licencia (office) de equipo</h3>
...
<?php $this->widget('zii.widgets.CDetailView', array(
	...
	'attributes'=>array(
        ...
        array(
            'name'=>'Producto',
            'value'=> ($model->Producto == "") ? "N/A" : $model->producto->Dominio,
        ),
        array(
            'name'=>'Id_Licencia',
            'value'=> ($model->Id_Licencia == "") ? "N/A" : $model->Id_Licencia,
        ),
        array(
            'name'=>'Num_Licencia',
            'value'=> ($model->Num_Licencia == "") ? "N/A" : $model->Num_Licencia,
        ),
        array(
            'name'=>'Token',
            'value'=> ($model->Token == "") ? "N/A" : $model->Token,
        ),
        array(
            'name'=>'Notas',
		...
		array(
            'name'=>'Fecha_Inicio',
            'value'=> ($model->Fecha_Inicio == "") ? "N/A" : UtilidadesVarias::textofecha($model->Fecha_Inicio),
        ),
        array(
            'name'=>'Fecha_Final',
            'value'=> ($model->Fecha_Final == "") ? "N/A" : UtilidadesVarias::textofecha($model->Fecha_Final),
        ),
        array(
            'name'=>'Empresa_Compra',
...
<div class="btn-group" style="padding-bottom: 2%">
   ...
   <button type="button" class="btn btn-success" id="toogle_button"><i class="fa fa-low-vision"></i> Ver / Ocultar Documento(s) </button>
</div>
