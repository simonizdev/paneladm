...
<div class="row">
 	  <div class="col-sm-8">
        <div class="form-group">
          <?php echo $form->error($model,'Id_Pc_Ext', array('class' => 'pull-right badge bg-red')); ?>
              ...
              'options'  => array(
                ...
                'minimumInputLength' => 3,
                  ...
                  'initSelection'=>'js:function(element,callback) {
                        ...
                        if ( id !== "" ) {
                          $.ajax("'.Yii::app()->createUrl('pcExteriorAnexo/SearchPcExtById').'", {
                              data: { id: id },
                              dataType: "json"
...
$(function() {
	...
	$("#valida_form").click(function() {
      var form = $("#pc-exterior-anexo-form");
      var settings = form.data('settings') ;

      var soporte = $('#PcExteriorAnexo_doc').val();
  	...
  	$("#PcExteriorAnexo_doc").change(function () {
