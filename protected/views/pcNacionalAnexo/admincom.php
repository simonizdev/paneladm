...
<h3>Administración de anexos por control nacional (comercial)</h3>
		...
		array(
            ...
            'buttons'=>array(
                'view'=>array(
                    ...
                    'url'=>'Yii::app()->createUrl("pcNacionalAnexo/view", array("id"=>$data->Id_Anexo_Pc_Nacional, "tipo"=>Yii::app()->params->pc_comercial))',
                ),
                'update'=>array(
                    ...
                    'url'=>'Yii::app()->createUrl("pcNacionalAnexo/update", array("id"=>$data->Id_Anexo_Pc_Nacional, "tipo"=>Yii::app()->params->pc_comercial))',
                ),
            )
		),
	),
