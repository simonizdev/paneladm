...
<h3>Visualizando anexo de control nacional</h3>
...
<?php $this->widget('zii.widgets.CDetailView', array(
	...
	'attributes'=>array(
		...
		array(
            'name'=>'Id_Pc_Nacional',
            'value'=>$model->Desc_Pc_Nacional($model->Id_Pc_Nacional),
        ),
        array(
            'name' => 'Tipo',
...
<div class="btn-group" style="padding-bottom: 2%">
    <button type="button" class="btn btn-success" onclick="location.href = '<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=pcNacionalAnexo/admin'; ?>';"><i class="fa fa-reply"></i> Volver </button>
...
<script type="text/javascript">
renderPDF('<?php echo Yii::app()->getBaseUrl(true).'/images/docs_pc_nac/'.$model->Doc_Soporte; ?>', document.getElementById('viewer'));
</script>