...
<h3>Asociando licencia de sistema operativo a equipo</h3>

<?php $this->renderPartial('_form', array('model'=>$model, 'e' => $e, 'tipos_licencia' => $tipos_lic, 'versiones_so' => $vers_so)); ?>
