...
$(function() {
	...
	$("#EquipoAntivirus_Fecha_Inicio").datepicker({
	  language: 'es',
	  autoclose: true,
	  orientation: "right bottom",
	}).on('changeDate', function (selected) {
	   var minDate = new Date(selected.date.valueOf());
	   $('#EquipoAntivirus_Fecha_Final').datepicker('setStartDate', minDate);
	});

	$("#EquipoAntivirus_Fecha_Final").datepicker({
	  language: 'es',
	  autoclose: true,
	  orientation: "right bottom",
	}).on('changeDate', function (selected) {
	   var maxDate = new Date(selected.date.valueOf());
	   $('#EquipoAntivirus_Fecha_Inicio').datepicker('setEndDate', maxDate);
	});
