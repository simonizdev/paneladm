	...
	<div class="row">
	    <div class="col-sm-3">
	    	<div class="form-group">
	          	<?php echo $form->label($model,'Id_M_Perfil'); ?>
			    <?php echo $form->numberField($model,'Id_M_Perfil', array('class' => 'form-control', 'autocomplete' => 'off', 'type' => 'number')); ?>
	        </div>
	    </div>
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'MenuPerfil[perfil]',
						'id'=>'MenuPerfil_perfil',
						'data'=>$lista_perfiles,
						'htmlOptions'=>array(),
					  	'options'=>array(
	...
	<div class="row">
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'MenuPerfil[usuario_creacion]',
						'id'=>'MenuPerfil_usuario_creacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'MenuPerfil[usuario_actualizacion]',
						'id'=>'MenuPerfil_usuario_actualizacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
...
<script type="text/javascript">
	...
	function resetfields(){
		$('#MenuPerfil_Id_M_Perfil').val('');
		$('#MenuPerfil_perfil').val('').trigger('change');
		$('#MenuPerfil_menu').val('').trigger('change');
		$('#MenuPerfil_usuario_creacion').val('').trigger('change');
		$('#MenuPerfil_Fecha_Creacion').val('');
		$('#MenuPerfil_usuario_actualizacion').val('').trigger('change');
