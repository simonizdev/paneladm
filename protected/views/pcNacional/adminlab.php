...
<h3>Panel de control nacional (Laboral)</h3>
        ...
        array(
            ...
            'buttons'=>array(
                'view'=>array(
                    ...
                    'url'=>'Yii::app()->createUrl("pcNacional/view", array("id"=>$data->Id_Pc_Nacional, "tipo"=>Yii::app()->params->pc_laboral))',
                ),
                'update'=>array(
                    ...
                    'url'=>'Yii::app()->createUrl("pcNacional/update", array("id"=>$data->Id_Pc_Nacional, "tipo"=>Yii::app()->params->pc_laboral))',
                ),
            )
        ),
	),
...
$(function() {
  ...
  var url = "<?php echo Yii::app()->createUrl('PcNacional/ViewRes&opc=5'); ?>";
