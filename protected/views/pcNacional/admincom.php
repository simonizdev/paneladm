...
<h3>Panel de control nacional (Comercial)</h3>
		...
		array(
            ...
            'buttons'=>array(
                'view'=>array(
                    ...
                    'url'=>'Yii::app()->createUrl("pcNacional/view", array("id"=>$data->Id_Pc_Nacional, "tipo"=>Yii::app()->params->pc_comercial))',
                ),
                'update'=>array(
                    ...
                    'url'=>'Yii::app()->createUrl("pcNacional/update", array("id"=>$data->Id_Pc_Nacional, "tipo"=>Yii::app()->params->pc_comercial))',
                ),
            )
		),
	),
...
$(function() {
  ...
  var url = "<?php echo Yii::app()->createUrl('PcNacional/ViewRes&opc=1'); ?>";
