...
<div class="row">
    	...
    	<div class="form-group">
            ...
            <?php
                $this->widget('ext.select2.ESelect2',array(
                    'name'=>'EquipoAutodesk[Tipo_Licencia]',
                    'id'=>'EquipoAutodesk_Tipo_Licencia',
                    'data'=>$tipos_licencia,
    ...
    <div class="col-sm-4">
    	<div class="form-group">
            ...
            <?php
                $this->widget('ext.select2.ESelect2',array(
                    'name'=>'EquipoAutodesk[Version]',
                    'id'=>'EquipoAutodesk_Version',
                    'data'=>$versiones_autodesk,
                    'value' => $model->Version,
                    'htmlOptions'=>array(),
                    'options'=>array(
                        'placeholder'=>'Seleccione...',
...
<div class="row">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <?php
                $this->widget('ext.select2.ESelect2',array(
                    'name'=>'EquipoAutodesk[Empresa_Compra]',
                    'id'=>'EquipoAutodesk_Empresa_Compra',
                    'data'=>$lista_empresas,
...
<div class="row">
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <?php
                $this->widget('ext.select2.ESelect2',array(
                    'name'=>'EquipoAutodesk[Proveedor]',
                    'id'=>'EquipoAutodesk_Proveedor',
...
<div class="row">
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <?php
                $this->widget('ext.select2.ESelect2',array(
                    'name'=>'EquipoAutodesk[Estado]',
                    'id'=>'EquipoAutodesk_Estado',
                    'data'=>$estados,
                    'value' => $model->Estado,
                    'htmlOptions'=>array(),
                    'options'=>array(
...
$(function() {
	...
	$("#valida_form").click(function() {
      var form = $("#equipo-autodesk-form");
      var settings = form.data('settings') ;

      var soporte = $('#EquipoAutodesk_sop').val();
  	...
  	$("#EquipoAutodesk_sop").change(function () {
