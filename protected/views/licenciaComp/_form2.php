...
<div class="row">
 	<div class="col-sm-4">
      	<div class="form-group">
      		<?php echo $form->error($model,'Software', array('class' => 'pull-right badge bg-red')); ?>
      		<?php echo $form->label($model,'Software'); ?>
      		<?php echo $form->textField($model,'Software', array('class' => 'form-control', 'maxlength' => '200', 'autocomplete' => 'off', 'onkeyup' => 'convert_may(this)')); ?>
      	</div>
  	</div>
  	<div class="col-sm-4">
      	<div class="form-group">
...
<div class="row">
	...
	<div class="col-sm-4">
    	<div class="form-group">
		    ...
		    <?php echo $form->textField($model,'Fecha_Inicio_Sop', array('class' => 'form-control', 'readonly' => true)); ?>
        </div>
    </div>
    <div class="col-sm-4">
    	<div class="form-group">
		    ...
		    <?php echo $form->textField($model,'Fecha_Final_Sop', array('class' => 'form-control', 'readonly' => true)); ?>
        </div>
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="col-sm-4">
        <div class="form-group">
          <?php echo $form->error($model,'Factura_Compra', array('class' => 'pull-right badge bg-red')); ?>
          <?php echo $form->label($model,'Factura_Compra'); ?>
          <?php echo $form->textField($model,'Factura_Compra', array('class' => 'form-control', 'maxlength' => '50', 'autocomplete' => 'off', 'onkeyup' => 'convert_may(this)')); ?>
        </div>
    </div>
    <div class="col-sm-4">
      	<div class="form-group">
...
$(function() {
	...
	$("#valida_form").click(function() {
      var form = $("#licencia-comp-form");
      var settings = form.data('settings') ;

      var soporte = $('#LicenciaComp_sop').val();
    ...
    $("#LicenciaComp_Fecha_Inicio_Sop").datepicker({
      language: 'es',
      autoclose: true,
      orientation: "right bottom",
    }).on('changeDate', function (selected) {
       var minDate = new Date(selected.date.valueOf());
       $('#LicenciaComp_Fecha_Final_Sop').datepicker('setStartDate', minDate);
    });

    $("#LicenciaComp_Fecha_Final_Sop").datepicker({
      language: 'es',
      autoclose: true,
      orientation: "right bottom",
    }).on('changeDate', function (selected) {
       var maxDate = new Date(selected.date.valueOf());
       $('#LicenciaComp_Fecha_Inicio_Sop').datepicker('setEndDate', maxDate);
    });

  	$("#LicenciaComp_sop").change(function () {
