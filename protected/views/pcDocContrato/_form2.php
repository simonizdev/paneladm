              ...
              'options'  => array(
                ...
                'minimumInputLength' => 3,
                  ...
                  'initSelection'=>'js:function(element,callback) {
                        ...
                        if ( id !== "" ) {
                          $.ajax("'.Yii::app()->createUrl('pcDocContrato/SearchContratoById').'", {
                              data: { id: id },
                              dataType: "json"
...
<div class="btn-group" id="buttons">
    <button type="button" class="btn btn-success" onclick="location.href = '<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=pcDocContrato/admin'; ?>';"><i class="fa fa-reply"></i> Volver</button>
...
$(function() {
	...
	$("#valida_form").click(function() {
      var form = $("#pc-doc-contrato-form");
      var settings = form.data('settings') ;

      var soporte = $('#PcDocContrato_doc').val();
  	...
  	$("#PcDocContrato_doc").change(function () {
