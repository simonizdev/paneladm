...
<h3>Visualizando anexo de control registro</h3>
...
<?php $this->widget('zii.widgets.CDetailView', array(
	...
	'attributes'=>array(
		...
		array(
            'name'=>'Id_Pc_Registro',
            'value'=>$model->Desc_Pc_Reg($model->Id_Pc_Registro),
        ),
		'Titulo',
		'Descripcion',
		array(
...
<script type="text/javascript">
renderPDF('<?php echo Yii::app()->getBaseUrl(true).'/images/docs_pc_reg/'.$model->Doc_Soporte; ?>', document.getElementById('viewer'));
</script>
