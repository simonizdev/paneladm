	...
	<div class="row">
	    <div class="col-sm-3">
	    	<div class="form-group">
			    ...
			    <?php echo $form->numberField($model,'Id_Proveedor', array('class' => 'form-control', 'autocomplete' => 'off', 'type' => 'number')); ?>
	        </div>
	    </div>
	    <div class="col-sm-3">
	    	<div class="form-group">
	...
	<div class="row">
	    	...
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'Proveedor[usuario_creacion]',
						'id'=>'Proveedor_usuario_creacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'Proveedor[usuario_actualizacion]',
						'id'=>'Proveedor_usuario_actualizacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	...
	<div class="row">
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'Proveedor[orderby]',
						'id'=>'Proveedor_orderby',
						'data'=>$array_orden,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	    	...
	    	<div class="form-group">
	          	<?php 
					$this->widget('application.extensions.PageSize.PageSize', array(
					        'mGridId' => 'proveedor-grid', //Gridview id
...
<script type="text/javascript">
	...
	function resetfields(){
		...
		$('#Proveedor_Proveedor').val('');
		$('#Proveedor_usuario_creacion').val('').trigger('change');
		$('#Proveedor_Fecha_Creacion').val('');
		$('#Proveedor_usuario_actualizacion').val('').trigger('change');
		$('#Proveedor_Fecha_Actualizacion').val('');
		$('#Proveedor_Estado').val('').trigger('change');
		$('#Proveedor_orderby').val('').trigger('change');
		$('#yt0').click();
	}
