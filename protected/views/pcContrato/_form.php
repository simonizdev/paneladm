  ...
  <div class="col-sm-4">
	...
	<div class="col-sm-4">
        <div class="form-group">
            ...
            <?php
                $this->widget('ext.select2.ESelect2',array(
                    'name'=>'PcContrato[Estado]',
                    'id'=>'PcContrato_Estado',
                    'data'=>$estados,
                    'value' => $model->Estado,
                    'htmlOptions'=>array(),
                    'options'=>array(
...
$(function() {
	...
	$("#PcContrato_Fecha_Inicial").datepicker({
	  language: 'es',
	  autoclose: true,
	  orientation: "right bottom",
	}).on('changeDate', function (selected) {
	   var minDate = new Date(selected.date.valueOf());
	   $('#PcContrato_Fecha_Final').datepicker('setStartDate', minDate);
	});

	$("#PcContrato_Fecha_Final").datepicker({
	  language: 'es',
	  autoclose: true,
	  orientation: "right bottom",
	}).on('changeDate', function (selected) {
  ...
  $("#PcContrato_Fecha_Ren_Can").datepicker({
    language: 'es',
    autoclose: true,
    orientation: "right bottom",
  }).on('changeDate', function (selected) {
