            ...
            <?php
                $this->widget('ext.select2.ESelect2', array(
                    ...
                    'options'  => array(
                        ...
                        'formatInputTooShort' =>  'js:function(){ return "Digite más de 3 caracteres para iniciar busqueda <button type=\"button\" class=\"btn btn-success btn-xs pull-right\" onclick=\"clear_select2_ajax(\'LicenciaEquipo_Id_Equipo\')\">Limpiar campo</button>"; }',
                    ),
                ));
            ?>
        </div>
...
<div class="btn-group" id="buttons">
    <button type="button" class="btn btn-success" onclick="location.href = '<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=licencia/view&id='.$l; ?>';"><i class="fa fa-reply"></i> Volver</button>
