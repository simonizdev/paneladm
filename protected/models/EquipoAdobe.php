...
/**
 * This is the model class for table "TH_EQUIPO_ADOBE".
 *
 * The followings are the available columns in table 'TH_EQUIPO_ADOBE':
 * @property integer $Id_Equipo_Adobe
 ...
 */
class EquipoAdobe extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('Tipo_Licencia, Version, Num_Licencia, Fecha_Inicio, Fecha_Final, Proveedor, Empresa_Compra, Numero_Factura, Fecha_Factura, Doc_Soporte, Estado', 'required'),
			...
			array('Id_Equipo_Adobe, Id_Equipo, Tipo_Licencia, Version, Num_Licencia, Fecha_Inicio, Fecha_Final, Proveedor, Empresa_Compra, Numero_Factura, Fecha_Factura, Doc_Soporte, Estado, Id_Usuario_Creacion, Fecha_Creacion, Id_Usuario_Actualizacion, Fecha_Actualizacion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('Id_Equipo_Adobe',$this->Id_Equipo_Adobe);
		...
		$criteria->order = 't.Id_Equipo_Adobe DESC'; 
	 ...
	 * @return EquipoAdobe the static model class
	 */
